...
import { createStock, changeProductStockName, getAllStocks, getStockById, requestSupplierForStockRefill, receiveOrderToStock, updateStock, issueStockController } from "../controllers/stock.controllers.js";
...
stockRouter.put("/:stockId", authorize, authorizeRole("ADMIN", "STOCK_MANAGER"), updateStock);
...
stockRouter.post("/:stockId/issue", authorize, authorizeRole("STOCK_MANAGER", "ADMIN"), issueStockController);
